...
export default function Postbox() {
    return (
        <div className="w-full max-w-2xl mx-auto p-4 text-[#5e7593] border rounded-3xl border-[#405168] bg-white">
            {/* Author */}
            <div className="flex items-center mb-2">
                ...
                <div className="ml-auto flex space-x-2">
                    <span className="px-2 py-1 text-xs bg-[#e0e7f1] text-[#5e7593] rounded-full"><IoMdPricetag className="inline-block mr-1" />Software Engineering</span>
                </div>
            </div>
            {/* Post content */}
            {/* Title */}
            ...
            {/* Description */}
            <div className="mb-4 text-[#1c2a48]">
